      ...
      if (childNode["s-sr"]) {
        ...
        for (const siblingNode of childNodes) {
          if (siblingNode["s-hn"] !== childNode["s-hn"] || slotName !== "") {
            if (siblingNode.nodeType === 1 && slotName === siblingNode.getAttribute("slot")) {
    ...
    if (BUILD.style && Cstr.style) {
      ...
      if (!styles.has(scopeId2)) {
        ...
        BUILD.shadowDomShim && cmpMeta.$flags$ & 8) {
          style = await import("./shadow-css-QS7OV3E7.js").then((m) => m.scopeCss(style, scopeId2, false));
        }
...
*/
//# sourceMappingURL=chunk-7DOXRABN.js.map
